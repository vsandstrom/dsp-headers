...
void fft(float data_real[], float data_imagined[], const unsigned N);
// helper
void rearrange(float data_real[], float data_imagined[], const unsigned N);
// Heavy lifting
void compute(float data_real[], float data_imagined[], const unsigned N);

float signal_re[N_FFT];
float signal_im[N_FFT];

...
TARGETS = combtest fmtest delaytest envtest demotest complextest osctest verbtest verbtest2 verbtest3 graintest envelope_test biquadtest resonatortest
# vectest
CFLAGS := -std=c++14 -O3 -march=native -msse -mavx -I./$(SRC_DIR) $(INCLUDES)
